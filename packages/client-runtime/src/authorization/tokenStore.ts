...
import { RelayManagedEndpoint } from "@eflob/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@eflob/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@eflob/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
