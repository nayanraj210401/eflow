import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@eflob/contracts";
import { resolveRemotePairingTarget } from "@eflob/shared/remote";
...
>()("@eflob/client-runtime/connection/onboarding/ConnectionOnboarding") {}
