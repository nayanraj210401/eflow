import { EnvironmentId, type DesktopSshEnvironmentTarget } from "@eflob/contracts";
import { RelayEnvironmentConnectScope } from "@eflob/contracts/relay";
import { RelayClientTracer } from "@eflob/shared/relayTracing";
