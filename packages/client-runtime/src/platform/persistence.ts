...
>()("@eflob/client-runtime/platform/persistence/ConnectionTargetStore") {}
...
>()("@eflob/client-runtime/platform/persistence/ConnectionRegistrationStore") {}
...
>()("@eflob/client-runtime/platform/persistence/EnvironmentCacheStore") {}
...
}>("@eflob/client-runtime/platform/persistence/EnvironmentOwnedDataCleanup", {
  defaultValue: () => ({
    clear: () => Effect.void,
  }),
}) {}
