import type { VcsStatusRemoteResult, VcsStatusResult } from "@eflob/contracts";
...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:eflob/eflob.git")).toBe(
      "github.com/eflob/eflob",
    );
    expect(normalizeGitRemoteUrl("https://github.com/eflob/eflob.git")).toBe(
      "github.com/eflob/eflob",
    );
    expect(normalizeGitRemoteUrl("ssh://git@github.com/eflob/eflob")).toBe(
      "github.com/eflob/eflob",
    );
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:eflob/platform/eflob.git")).toBe(
      "gitlab.com/eflob/platform/eflob",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/eflob/platform/eflob.git")).toBe(
      "gitlab.com/eflob/platform/eflob",
    );
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("git@github.com:eflob/eflob.git"),
    ).toBe("eflob/eflob");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("https://github.com/eflob/eflob.git"),
    ).toBe("eflob/eflob");
  });
});
