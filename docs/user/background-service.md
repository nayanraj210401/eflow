# Running eflob in the Background

On a Linux host, eflob can run as a background service for your user. It starts when the machine
boots and keeps running after you log out.

## Manage the Service

Install it with the latest eflob release:
...
Updating restarts eflob briefly. Let active agent work and terminal commands finish first.
...
want eflob to start in the background.
