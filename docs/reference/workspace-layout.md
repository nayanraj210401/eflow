...
- `/packages/shared`: Shared runtime utilities consumed by both server and web. Uses explicit subpath exports (e.g. `@eflob/shared/git`, `@eflob/shared/DrainableWorker`) — no barrel index.
