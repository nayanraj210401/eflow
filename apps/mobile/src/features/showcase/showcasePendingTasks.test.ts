import type { EnvironmentProject } from "@eflob/client-runtime/state/shell";
import { EnvironmentId, ProjectId, ProviderInstanceId } from "@eflob/contracts";
...
const projects: ReadonlyArray<EnvironmentProject> = [
  {
    ...
    id: ProjectId.make("eflob"),
    title: "eflob",
    workspaceRoot: "/workspace/eflob",
