...
describe("isLegalDocumentUrl", () => {
  it.each([
    "https://eflob.dev/legal",
    "https://eflob.dev/legal/",
    "https://eflob.dev/privacy-policy?source=app",
    "https://eflob.dev/terms-of-service#updates",
    "https://eflob.dev/security-policy",
  ])("allows a configured legal document: %s", (url) => {
    expect(isLegalDocumentUrl(url)).toBe(true);
  });

  it.each([
    "https://eflob.dev/download",
