import type { EnvironmentId, SidebarThreadSortOrder } from "@eflob/contracts";
...
import { EflobWordmark } from "../../components/EflobWordmark";
        ...
        <View className="w-full max-w-[720px] self-center gap-3">
          <View className="flex-row items-center gap-2.5">
            <View className="flex-1 flex-row items-center gap-2">
              <EflobWordmark color={iconColor} height={15} />
