import { type KnownTerminalSession } from "@eflob/client-runtime/state/terminal";
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@eflob/contracts";
...
} from "@eflob/shared/terminalLabels";
