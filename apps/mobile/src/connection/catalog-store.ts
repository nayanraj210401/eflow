...
import { ConnectionTransientError } from "@eflob/client-runtime/connection";
...
export const CONNECTION_CATALOG_KEY = "eflob.connection-catalog.v1";
export const LEGACY_CONNECTIONS_KEY = "eflob.connections";
