...
import type { EnvironmentPresentation } from "@eflob/client-runtime/connection";
import { createEnvironmentPresentationAtoms } from "@eflob/client-runtime/state/presentation";
