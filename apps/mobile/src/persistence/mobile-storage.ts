...
const CONNECTIONS_KEY = "eflob.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "eflob.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "eflob.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "eflob.recent-thread-shortcuts";
...
>()("@eflob/mobile/persistence/MobileStorage") {}
