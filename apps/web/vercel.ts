...
const ROUTER_HOST = "app.eflob.dev";
const HOSTED_WEB_CHANNEL_COOKIE = "eflob_web_channel";
const LATEST_ORIGIN = "https://latest.app.eflob.dev";
const NIGHTLY_ORIGIN = "https://nightly.app.eflob.dev";
...
export const config: VercelConfig = {
  buildCommand:
    'vp run --filter @eflob/web build && node ../../scripts/apply-web-brand-assets.ts --channel "${VITE_HOSTED_APP_CHANNEL:-latest}"',
  git: {
    deploymentEnabled: false,
  },
  installCommand:
    "npm install -g vite-plus && vp install --filter '@eflob/scripts...' --filter '@eflob/web...'",
  routes: [
    {
      src: "/__eflob/channel",
