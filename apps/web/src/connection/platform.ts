...
} from "@eflob/client-runtime/platform";
import {
...
import { bootstrapRemoteBearerSession } from "@eflob/client-runtime/authorization";
import { fetchRemoteEnvironmentDescriptor } from "@eflob/client-runtime/environment";
import { managedRelayAccountChanges, managedRelaySessionAtom } from "@eflob/client-runtime/relay";
import { EnvironmentRpcRequestObserver } from "@eflob/client-runtime/rpc";
import {
...
function clientMetadata() {
  ...
  return {
    label: desktop ? "eflob Desktop" : "eflob Web",
