...
export const PERSISTED_STATE_KEY = "eflob:ui-state:v1";
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 1;
const LEGACY_PERSISTED_STATE_KEYS = [
  "eflob:renderer-state:v8",
  "eflob:renderer-state:v7",
  "eflob:renderer-state:v6",
  "eflob:renderer-state:v5",
  "eflob:renderer-state:v4",
  "eflob:renderer-state:v3",
