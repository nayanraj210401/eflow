import { CheckpointRef, EnvironmentId, MessageId, TurnId } from "@eflob/contracts";
        ...
        timelineEntries={[
          {
            ...
            entry: {
              ...
              label: "Updated files",
              tone: "tool",
              changedFiles: ["C:/Users/mike/dev-stuff/eflob/apps/web/src/session-logic.ts"],
            },
          },
        ]}
        workspaceRoot="C:/Users/mike/dev-stuff/eflob"
      />,
    );

    expect(markup).toContain("eflob/apps/web/src/session-logic.ts");
    expect(markup).not.toContain("C:/Users/mike/dev-stuff/eflob/apps/web/src/session-logic.ts");
  });
