...
>()("@eflob/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__EFLOB_ENV_${name}_START__`;
const endMarker = (name: string) => `__EFLOB_ENV_${name}_END__`;
