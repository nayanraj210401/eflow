...
const OVERLAY_ATTRIBUTE = "data-eflob-annotation-ui";
...
function startAnnotation(): void {
  ...
  const refreshToolButtons = (): void => {
    ...
    document.documentElement.setAttribute("data-eflob-annotation-tool", tool);
  };
  ...
  const teardown = (notifyMain: boolean): void => {
    ...
    document.documentElement.removeAttribute("data-eflob-annotation-tool");
    cursorStyle.remove();
    host.remove();
    activeSession = null;
