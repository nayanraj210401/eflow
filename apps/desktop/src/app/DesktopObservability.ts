import { PRIMARY_LOCAL_ENVIRONMENT_ID } from "@eflob/contracts";
import { makeLocalFileTracer, makeTraceSink } from "@eflob/shared/observability";
...
>()("@eflob/desktop/app/DesktopObservability/DesktopBackendOutputLogFactory") {}
