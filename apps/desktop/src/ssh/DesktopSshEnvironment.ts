...
import * as SshAuth from "@eflob/ssh/auth";
import { discoverSshHosts } from "@eflob/ssh/config";
import {
  SshCommandError,
  ...
  SshReadinessError,
} from "@eflob/ssh/errors";
import * as SshTunnel from "@eflob/ssh/tunnel";
...
>()("@eflob/desktop/ssh/DesktopSshEnvironment") {}
...
export function toSshPasswordPromptError(
  ...
  switch (cause._tag) {
    ...
    case "DesktopSshPromptPresentationError":
      message = "eflob window is not available for SSH authentication.";
      break;
