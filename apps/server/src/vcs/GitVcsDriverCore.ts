...
import { dedupeRemoteBranchesWithLocalMatches, normalizeGitRemoteUrl } from "@eflob/shared/git";
import { compactTraceAttributes } from "@eflob/shared/observability";
import { decodeJsonResult } from "@eflob/shared/schemaJson";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `eflob-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
