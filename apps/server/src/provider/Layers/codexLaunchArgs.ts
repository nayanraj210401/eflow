import { tokenizeCliArgs } from "@eflob/shared/cliArgs";

export const EFLOB_CODEX_LAUNCH_ARGS_ENV = "EFLOB_CODEX_LAUNCH_ARGS";

export const resolveCodexLaunchArgs = (
  launchArgs?: string,
  environment: NodeJS.ProcessEnv = process.env,
) => environment[EFLOB_CODEX_LAUNCH_ARGS_ENV]?.trim() || launchArgs?.trim() || "";
