          ...
          Layer.mergeAll(
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  EFLOB_LOG_LEVEL: "Warn",
                  EFLOB_MODE: "desktop",
                  EFLOB_PORT: "4001",
                  EFLOB_HOST: "0.0.0.0",
                  EFLOB_HOME: baseDir,
                  VITE_DEV_SERVER_URL: "http://127.0.0.1:5173",
                  EFLOB_NO_BROWSER: "true",
                  EFLOB_AUTO_BOOTSTRAP_PROJECT_FROM_CWD: "false",
                  EFLOB_LOG_WS_EVENTS: "true",
                },
              }),
            ),
            NetService.layer,
            ...
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  ...
                  EFLOB_PORT: "4001",
                  EFLOB_HOST: "0.0.0.0",
                  EFLOB_HOME: join(NodeOS.tmpdir(), "ignored-base"),
                  VITE_DEV_SERVER_URL: "http://127.0.0.1:5173",
                  EFLOB_NO_BROWSER: "false",
                  EFLOB_AUTO_BOOTSTRAP_PROJECT_FROM_CWD: "false",
                  EFLOB_LOG_WS_EVENTS: "false",
                },
              }),
            ),
            NetService.layer,
        ...
        Effect.provide(
          Layer.mergeAll(
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  EFLOB_BOOTSTRAP_FD: String(fd),
                  EFLOB_NO_BROWSER: "true",
                  EFLOB_AUTO_BOOTSTRAP_PROJECT_FROM_CWD: "true",
                  EFLOB_LOG_WS_EVENTS: "true",
                },
              }),
            ),
