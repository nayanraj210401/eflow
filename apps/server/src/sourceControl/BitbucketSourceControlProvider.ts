...
import { SourceControlProviderError, type ChangeRequest } from "@eflob/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set EFLOB_BITBUCKET_EMAIL and EFLOB_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request and repository scopes).",
