import { readConnectAuthorizeRequest } from "@eflob/shared/connectAuth";
...
const TEST_ENV = {
  EFLOB_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  EFLOB_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  EFLOB_HOSTED_APP_URL: "https://hosted.example.test",
};
