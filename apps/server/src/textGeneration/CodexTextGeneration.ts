...
import { type CodexSettings, type ModelSelection } from "@eflob/contracts";
...
import { getModelSelectionStringOptionValue } from "@eflob/shared/model";
...
export const makeCodexTextGeneration = Effect.fn("makeCodexTextGeneration")(function* (
  ...
  const writeTempFile = (
    ...
    fileSystem
      .makeTempFileScoped({
        prefix: `eflob-${prefix}-${process.pid}-`,
      })
      .pipe(
