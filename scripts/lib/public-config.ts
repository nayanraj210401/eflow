...
export interface eflobPublicConfig {
...
export function loadRepoEnv({
  ...
  return {
    ...
    ...(config.clerkPublishableKey
      ? {
          EFLOB_CLERK_PUBLISHABLE_KEY: config.clerkPublishableKey,
    ...
    ...(config.clerkJwtTemplate
      ? {
          EFLOB_CLERK_JWT_TEMPLATE: config.clerkJwtTemplate,
...
export function resolvePublicConfig(...sources: readonly Environment[]): eflobPublicConfig {
  return {
