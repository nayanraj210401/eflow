export const BRAND_ASSET_PATHS = {
  ...
  productionIosIconPng: "assets/prod/eflob-ios-1024.png",
  productionMacIconPng: "assets/prod/eflob-macos-1024.png",
  productionLinuxIconPng: "assets/prod/eflob-universal-1024.png",
  productionWindowsIconIco: "assets/prod/eflob-windows.ico",
  productionWebFaviconIco: "assets/prod/eflob-web-favicon.ico",
  productionWebFavicon16Png: "assets/prod/eflob-web-favicon-16x16.png",
  productionWebFavicon32Png: "assets/prod/eflob-web-favicon-32x32.png",
  productionWebAppleTouchIconPng: "assets/prod/eflob-web-apple-touch-180.png",
