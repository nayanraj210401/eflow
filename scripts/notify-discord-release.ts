  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new eflob prerelease is available for nightly testers."
          : "A new eflob latest release is available.",
...
).pipe(Command.withDescription("Post a eflob release announcement to Discord."));
